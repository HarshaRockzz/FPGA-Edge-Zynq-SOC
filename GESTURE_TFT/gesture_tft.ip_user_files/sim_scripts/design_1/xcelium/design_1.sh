...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../gesture_tft.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../gesture_tft.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../gesture_tft.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../gesture_tft.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"E:/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
